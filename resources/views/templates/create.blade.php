...
@section('page.title', ' - Создание шаблона')
...
@section('forms.content')
    <div class="row justify-content-center">
        <div class="bg-white col-xl-5 col-lg-6 col-md-8 col-sm-10 rounded-4 p-4">
            ...
            <h1 class="display-6 text-center mb-4">{{ __('Создание шаблона') }}</h1>

            <x-errors />

            <form method="post" action="{{ route('templates.store') }}" class="form">
                @csrf
                        ...
                        @foreach($categories as $categoryLvl1)
                            <div style="margin-bottom: 1rem; border-left: 1px solid #ededed; padding-left: 0.5rem;" class="cat">
                                <div class="form-check d-flex">
                                    <input class="form-check-input" type="checkbox" value="1" name="{{ "cat_{$categoryLvl1['id']}" }}" id="{{ "cat_{$categoryLvl1['id']}" }}">
                                ...
                                @if(isset($categoryLvl1['items']))
                                    @foreach($categoryLvl1['items'] as $categoryLvl2)
                                        <div style="padding-left: 1rem;" class="cat">
                                            <div class="form-check d-flex">
                                                <input class="form-check-input" type="checkbox" value="1" name="{{ "cat_{$categoryLvl2['id']}" }}" id="{{ "cat_{$categoryLvl2['id']}" }}">
                                            ...
                                            @if(isset($categoryLvl2['items']))
                                                @foreach($categoryLvl2['items'] as $categoryLvl3)
                                                    <div style="padding-left: 2rem;" class="cat">
                                                        <div class="form-check d-flex">
                                                            <input class="form-check-input" type="checkbox" value="1" name="{{ "cat_{$categoryLvl3['id']}" }}" id="{{ "cat_{$categoryLvl3['id']}" }}">
                                                        ...
                                                        @if(isset($categoryLvl3['items']))
                                                            @foreach($categoryLvl3['items'] as $categoryLvl4)
                                                                <div style="padding-left: 3rem;" class="cat">
                                                                    <div class="form-check d-flex">
                                                                        <input class="form-check-input" type="checkbox" value="1" name="{{ "cat_{$categoryLvl4['id']}" }}" id="{{ "cat_{$categoryLvl4['id']}" }}">
                                                                    ...
                                                                    @if(isset($categoryLvl4['items']))
                                                                        @foreach($categoryLvl4['items'] as $categoryLvl5)
                                                                            <div style="padding-left: 4rem;" class="cat">
                                                                                <div class="form-check d-flex">
                                                                                    <input class="form-check-input" type="checkbox" value="1" name="{{ "cat_{$categoryLvl5['id']}" }}" id="{{ "cat_{$categoryLvl5['id']}" }}">
